...
c = ['animal_ID', 'eyes_on_screen_d', 'not_eyes_on_screen_d','lipsmacking_d', 'eyes_on_screen_and_lipsmacking_d',  'face_d', 'looking_at_face_d', 'not_looking_at_face_d', 'ratio_eyes_on_screen_and_lipsmacking', 'ratio_not_eyes_on_screen_and_lipsmacking',  'looking_at_face_and_lipsmacking_d', 'not_looking_at_face_and_lipsmacking_d', 'ratio_looking_at_face', 'ratio_not_looking_at_face']
...
#face
    ...
    not_looking_at_face=df1['face'] == 0 
...
columns1=['animal_ID', 'face','not_face', 'screen', 'not_screen']
...
for animal_ID in IDS:
    ...
    df_tmp = pd.DataFrame([[animal_ID, ratio_face_ls, ratio_not_face_ls, ratio_screen_ls, ratio_not_screen_ls]], columns=columns1)
...
cf=df_ratios[ ['face', 'not_face'] ].iloc[ [1,2,3,4,5,6] ]
...
plt.bar(ind+width,res1['not_face'],width,label='not fixating face')
plt.ylabel('Fraction time lipsmacking')
